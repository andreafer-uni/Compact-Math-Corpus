...
if "senter" not in nlp.pipe_names and "parser" not in nlp.pipe_names:
    print("Warning: The sentence segmentation model is not enabled!")

nlp.add_pipe("conll_formatter", last=True)

json_path = "lahefferon-cleaned.json"
output_conll_path = "lahefferon.conll"

def generate_conll(json_file, output_file):
    """Processes a JSON file and generates a CoNLL file."""
...
if __name__ == "__main__":
    generate_conll(json_path, output_conll_path)
