...
def generate_trf_summary(json_path, csv_output):
    ...
    if not sentences:
        print("No sentences found in the JSON file.")
        return
    ...
    df_stats.to_csv(csv_output, index=False, encoding="utf-8")

    print(f"Statistics saved in: {csv_output}")
